...
# 导入自定义的类
from models.cnn_transformer_conv1x1_wdirection import CNNTransformer
...
learning_rate = 1e-3
num_epochs = 20
batch_size = 5 # 2->2981(90*300) ,1->26G(375*1242), 1->5522M(180*600)
...
scheduler = torch.optim.lr_scheduler.MultiStepLR(optimizer, milestones=[8, 14, 16], gamma=0.1)
